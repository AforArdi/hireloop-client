  ...
  return (
    <section className="relative w-full bg-[#050505] text-white pt-20 pb-24 overflow-hidden flex flex-col items-center">
      ...
      <div className="relative w-full max-w-6xl mx-auto mt-24 px-6 flex flex-col items-center">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] md:w-[1200px] -z-10 opacity-70 pointer-events-none">
          <img src="/images/globe.png" alt="World Globe" className="w-full h-auto object-cover blur-[1px]" />
        </div>

        <h2 className="text-3xl md:text-4xl font-medium text-center mb-16 relative z-10 max-w-2xl">
